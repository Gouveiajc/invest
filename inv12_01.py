...
import inv12_02     # módulo de inclusão
import inv12_03     # módulo de alteração
...
def abrir_lista(root):
    ...
    ttk.Button(frame_botoes, text="INCLUIR", width=12,
               command=lambda: inv12_02.abrir_janela_inv01(janela, tree) ).pack(side="left", padx=5)

    ttk.Button(frame_botoes, text="ALTERAR", width=12,
               command=lambda: inv12_03.alterar_registro(tree)).pack(side="left", padx=5)
