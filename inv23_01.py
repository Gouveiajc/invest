...
def obter_dados():
    ...
    for r in linhas:
        ...
        if usa_cotacao and cotacao_valida:
            ...
            if exterior == "S":
                total_brl = custo_usd * cotacao_moeda #* qtd 
            else:
                total_brl = custo_brl #* qtd

            valor_unit_brl = total_brl / qtd if qtd else 0.0
            valor_fallback = True  # <<< MARCA QUE O VALOR NÃO É REAL
        ...
        ativo = {
            ...
            "ValorFallback": valor_fallback,  # <<< FLAG PARA O GRID
        }
...
def abrir_grids(tipos, segmentos, ativos):
    ...
    for a in ativos:
        ...
        # ============================================================
        # APLICA ASTERISCO SE O VALOR FOR FALLBACK
        # ============================================================
